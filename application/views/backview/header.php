...
<head>
    ...
    <!-- Custom CSS untuk CKEditor Content - Auto Center Images -->
    <style>
        /* Universal style untuk semua content dari CKEditor */
        figure.image,
        figure.easyimage,
        ...
        /* Untuk gambar biasa yang bukan dalam figure */
        p img {
            display: block !important;
            margin: 20px auto !important;
            max-width: 100%;
        ...
        /* Jika gambar ada background abu-abu seperti di screenshot */
        figure.image,
        figure.easyimage,
        .easyimage {
            background: #f5f5f5;
