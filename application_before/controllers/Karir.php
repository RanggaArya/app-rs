...
class Karir extends CI_Controller {
      ...
      public function edit($id)
        {
            $query = $this->db->get_where('karir_open', ['id' => $id]);
            $data['karir'] = $query->row();
            ...
            $this->load->view('backview/header.php');
            $this->load->view('backview/admin/navbar.php');
            $this->load->view('backview/admin/dashboard/karir_edit.php', $data);
            $this->load->view('backview/footer.php');
        }
        ...
        public function update()
        {
            ...
            // file lama
            $attachment = $this->input->post('old_attachment', TRUE);
            $hapus_attachment = $this->input->post('hapus_attachment', TRUE);
        
            // path file
            $file_path = './assets/karir/attachment/'.$attachment;
        
            // jika user memilih hapus file
            if ($hapus_attachment && $attachment) {
                if (file_exists($file_path)) {
                    unlink($file_path);
                }
                $attachment = NULL; // hapus dari database
            }
            ...
            $this->db->where('id', $id);
            $this->db->update('karir_open', $data);
